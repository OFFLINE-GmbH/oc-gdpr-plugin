<?php return [
    ...
    'settings' => [
        ...
        'general' => [
            ...
            'description' => 'Einstellungen zum GDPR-Plugin',
            'log_enabled' => [
    ...
    'permissions' => [
        ...
        'manage_logs' => 'Kann Entscheidungs-Log sehen',
    ],
    'log' => [
        ...
        'declined' => 'Abgelehnt',
        'total' => 'Total',
        'total_logged' => 'Aufgezeichnete Anfragen',
        'log' => 'Cookie-Log',
        'log_comment' => 'Alte Log-Einträge entfernen',
    ],
];